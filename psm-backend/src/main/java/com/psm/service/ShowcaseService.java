...
public class ShowcaseService {
    ...
    public Result<?> getShowcaseBoxes(String token, ShowcaseBoxAto showcaseBoxAto) {
        try{
            ...
            list = showCaseMapper.getShowcaseBoxes(token, showcaseBoxAto.getPrimarySort(),
            showcaseBoxAto.getMiddleSort(), showcaseBoxAto.getLastSort(),
            showcaseBoxAto.getIsIdle(), showcaseBoxAto.getCanQuicky());
